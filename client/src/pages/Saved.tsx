...
const Saved = () => {
  ...
  // Filter ideas based on saved status (completed), search and category
  const filteredIdeas = ideas
    ? ideas
        .filter((idea) => idea.status === "completed") // Only show completed/saved ideas
        .filter((idea) => {
        ...
        <div className="text-center py-12 bg-white rounded-lg border border-gray-200">
          ...
          <p className="text-gray-500 mb-6">
            {searchQuery || selectedCategory !== null
              ...
              : "Mark ideas as completed to save them here"}
          </p>
        </div>
      )}
    </div>
